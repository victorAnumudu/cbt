...
export default function ReloadSpinner({timer, timerClass, size='6', fillColor='fill-blue-500'}:Props) {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="w-full flex flex-col justify-center items-center">
            <div role="status">
                <svg aria-hidden="true" className={`${spinnerHeight} ${spinnerWidth} text-gray-200 animate-spin dark:text-gray-600 ${fillColor}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
